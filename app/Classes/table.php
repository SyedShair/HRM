...
public static function addresshistory() 
	{
		$addresshistory = DB::table('tbl_address_history');
   ...
   public static function companydocuments()
{
    return DB::table('tbl_company_documents');
}
