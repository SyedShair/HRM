@extends('layouts.default')
 @php
        ...
        @endphp
    @section('meta')
        <title>General Settings | {{ $appName }}</title>
                    ...
                    <div class="ui tab active" data-tab="system">
                        <div class="col-md-12">
                            <div class="tab-content">
                                    ...
                                    @endif
                                    <form action="{{ url('settings/update') }}" class="ui form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                    <div class="content">
                                        @csrf

                                            <h4 class="ui dividing header">{{ __("Branding") }}</h4>

                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Application Name") }}
                                                    <div class="sub header">{{ __("Shown in the browser title and throughout the app") }}</div>
                                                </h2>
                                                <input type="text" name="app_name" value="{{ old('app_name', $data->app_name ?? '') }}" placeholder="{{ __('e.g. Workday') }}">
                                            </div>

                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Currency") }}
                                                    <div class="sub header">{{ __("Currency code or symbol used across reports and payroll") }}</div>
                                                </h2>
                                                <input type="text" name="currency" value="{{ old('currency', $data->currency ?? '') }}" maxlength="10" placeholder="{{ __('e.g. USD, GBP, PHP') }}">
                                            </div>

                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Application Logo") }}
                                                    <div class="sub header">{{ __("Recommended: PNG with transparent background") }}</div>
                                                </h2>
                                                @isset($data->app_logo)
                                                    <div style="margin-bottom:10px">
                                                        <img src="{{ asset('storage/'.$data->app_logo) }}" alt="Current logo" style="max-height:60px">
                                                    </div>
                                                @endisset
                                            ...
                                            <div class="eight wide field">
    <h2 class="ui small header">{{ __("GPS Location Tracking") }}
        <div class="sub header">{{ __("Turn on to capture employee GPS location on Clock In and Clock Out (like BrightHR)") }}</div>
    </h2>
    <div class="ui toggle checkbox ">
      <input type="checkbox" name="gps" @isset($data->gps)@if($data->gps == "on") checked @endif @endisset>
      <label>Toggle Off/On</label>
    </div>
</div>
                            ...
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                    ...
                                    <div class="footer-text">
                                        ...
                                        <div class="sub header">Copyright (c) 2026 Jpingos Flame Grill. All rights reserved.</div>
                                    </div>
                                </p>
                                <div class="ui section divider"></div>
                                <!--<h4 class="ui header">Send Feedback-->
                                <!--    <div class="sub header">Write your feedback and send it to our developer's email address syedshairali66@gmail.com</div>-->
                                <!--</h4>-->
                            </div>
                        </div>
                    </div>
