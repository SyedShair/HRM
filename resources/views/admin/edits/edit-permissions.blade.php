@extends('layouts.default')
    ...
    @section('meta')
        <title>Edit Permissions | Jpingos</title>
                                ...
                                <div class="ui relaxed list">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="list">
                                            ...
                                            <div class="item">
                                                <div class="ui child checkbox slider">
                                                    <input type="checkbox" @isset($d) @if(in_array('123', $d)==true) checked @endif @endisset name="perms[]" value="123">
                                                    <label>{{ __("Edit Department") }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="ui master checkbox">
                                            ...
                                            <div class="item">
                                                <div class="ui child checkbox slider">
                                                    ...
                                                    <label>{{ __("View Personal Attendance") }}</label>
                                                </div>
                                            </div>
                                        </div>
