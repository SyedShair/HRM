@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Profile | Jpingos</title>
                            ...
                            <p class="description text-center">
                                ...
                                <table style="width: 100%" class="profile-tbl">
                                    <tbody>
                                        <tr>
                                            <td>{{ __("Email") }}</td>
                                            <td><span class="p_value"
                                            @isset($profile->emailaddress)
                <a href="mailto:{{ $profile->emailaddress }}">{{ $profile->emailaddress }}</a>
            @endisset</span></td>
                                        </tr>
                                        <tr>
                                            <td>{{ __("Mobile no.") }}</td>
                                            <td><span class="p_value"> @isset($profile->mobileno)
                <a href="tel:{{ $profile->mobileno }}">{{ $profile->mobileno }}</a>
            @endisset</span></td>
                                        </tr>
...
<script>
  QRCode.toCanvas(document.getElementById('qrcode'), '{{$company_data->idno}}', function (error) {
