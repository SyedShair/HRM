@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Dashboard | Jpingos</title>
...
@php
    ...
    if ($employee && $employee->visaend) {
        ...
        // Positive = months remaining, negative = months past expiry
        $remainingMonths = $today->diffInMonths($visaEnd, false);
    }
@endphp
...
">
    ...
    <button class="toggle-btn" onclick="toggleVisaBox()">−</button>

    <div class="visa-mini-icon">
        🛂
    </div>
    ...
    <div class="visa-content">
        ...
        <div style="margin-bottom:6px;">
            <strong>Visa:</strong>
            {{ $employee->visastatus ?? 'N/A' }}
        </div>

        <div style="margin-bottom:6px;">
            <strong>Expiry:</strong>
            {{ $visaEnd->format('d M Y') }}
        </div>

        <div style="font-size:24px; font-weight:bold; margin-top:12px;">
            @if($remainingDays > 0)
